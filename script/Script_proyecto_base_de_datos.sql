...
(
  ...
  respondido VARCHAR(2) NULL,
  apeliddo VARCHAR(50) NOT NULL,
...
(
  id_perfiles INT NOT NULL IDENTITY,
...
(
  id_metodos_pago INT NOT NULL IDENTITY,
  metodo VARCHAR(50) NOT NULL,
  CONSTRAINT PK_METODOS_DE_PAGO_ID_METODOS_PAGO  PRIMARY KEY (id_metodos_pago)
);
...
(
  ...
  CONSTRAINT PK_PRODUCTOS_ID_PRODUCTOS  PRIMARY KEY (id_productos),
...
(
  ...
  CONSTRAINT FK_USUARIOS_ID_PERFILES FOREIGN KEY (id_perfiles) REFERENCES Perfiles(id_perfiles),
...
(
  ...
  CONSTRAINT FK_FACTURA_ID_METODOS_PAGO FOREIGN KEY (id_metodos_pago) REFERENCES metodos_de_pagos(id_metodos_pago),
...
(
  ...
  CONSTRAINT FK_PRODUCTO_DETALLE_ID_PRODUCTOS FOREIGN KEY (id_productos) REFERENCES Productos(id_productos),
