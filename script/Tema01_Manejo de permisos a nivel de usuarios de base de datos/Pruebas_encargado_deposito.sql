...
/*
Permisos sobre las tablas, El usuario tiene asignado un rol personalizado que le otorga acceso a las tablas productos,
producto detalle y categorias, de esta manera el usuario puede realizar sus tareas unicamente en las tablas que le corresponden
